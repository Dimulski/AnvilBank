...
namespace AnvilBank.Web.Pages.Account
{
    ...
    public class RegisterModel : BasePageModel
    {
        ...
        public RegisterModel(UserManager<BankUser> userManager, ILogger<RegisterModel> logger, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            var callbackUrl = this.Url.Page(
                ...
                this.Request.Scheme);
            await this.emailSender.SendEmailAsync(GlobalConstants.AnvilBankEmail, this.Input.Email,
